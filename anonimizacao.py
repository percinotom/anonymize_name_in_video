...
def bboxes(inp):
	...
	kernel = cv2.getStructuringElement(cv2.MORPH_CROSS, (3, 3))  #para manipular a orientação da diluição, x grande significa dilatar mais horizontalmente, y significa dilatar mais verticalmente
	...
	for contour in contours:
	    ...
	    cropped = video_final[y :y +  h , x : x + w]
